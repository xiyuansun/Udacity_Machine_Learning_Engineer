...
'''
The following code is to help you play woth the concept of Dataframe in Pandas.
...
The playground is inspired by Greg Reda's post on Intro to Pandas Data Structures:
