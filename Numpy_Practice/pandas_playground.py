...
an array, list, or column in a database.

By default, it will assign an index label to each item in the Series ranging from 0 to N, where N is the number of items in the Series minus one.
...
if False:
    series = pd.Series(['Dave', 'Cheng-Han', 359, 9001],
                       index = ['Introductor', 'Curriculum Manager',
